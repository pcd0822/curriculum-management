...
function HomePage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
      ...
      <h1 className="font-display text-2xl font-extrabold text-[#191c1e] mb-1">고교학점제</h1>
      <h2 className="font-display text-lg font-bold text-[#4f46e5] mb-2">진로학업설계</h2>
      <p className="text-[#777587] text-sm mb-10 max-w-xs">수강신청 · 진로탐색 · 학점관리 통합 플랫폼</p>
